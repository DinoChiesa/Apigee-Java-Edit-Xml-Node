...
1. copy the jar file, available in  target/edge-custom-edit-xml-node-1.0.8.jar , if you have built the jar, or in [the repo](bundle/apiproxy/resources/java/edge-custom-edit-xml-node-1.0.8.jar) if you have not, to your apiproxy/resources/java directory. You can do this offline, or using the graphical Proxy Editor in the Apigee Edge Admin Portal.
...
2. include an XML file for the Java callout policy in your
   ...
   ```xml
    <JavaCallout name='Java-EditXmlNode-1'>
      ...
      <ResourceURL>java://edge-custom-edit-xml-node-1.0.8.jar</ResourceURL>
    </JavaCallout>
   ```
